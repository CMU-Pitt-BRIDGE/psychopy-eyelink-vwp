...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/bridge-center/bridge/psychopy-eyelink-vwp/psychopy/intro.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        encoding_image.setImage(animal_image)
        encoding_audio.setSound(question_audio, secs=6, hamming=True)
        ...
        while continueRoutine and routineTimer.getTime() < 6.0:
            ...
            if encoding_image.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                thisExp.timestampOnFlip(win, 'encoding_image.started')
                # update status
            ...
            if encoding_image.status == STARTED:
                ...
                if tThisFlipGlobal > encoding_image.tStartRefresh + 6-frameTolerance:
                    ...
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'encoding_image.stopped')
                    # update status
            ...
            if encoding_audio.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.addData('encoding_audio.started', tThisFlipGlobal)
                # update status
            ...
            if encoding_audio.status == STARTED:
                ...
                if tThisFlipGlobal > encoding_audio.tStartRefresh + 6-frameTolerance:
                    ...
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'encoding_audio.stopped')
                    # update status
            ...
            if encoding_text.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'encoding_text.started')
                # update status
            ...
            if encoding_text.status == STARTED:
                ...
                if tThisFlipGlobal > encoding_text.tStartRefresh + 6-frameTolerance:
                    ...
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'encoding_text.stopped')
                    # update status
